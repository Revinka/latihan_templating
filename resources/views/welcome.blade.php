    ...
    <div class="container-fluid p-5 mb-5 bg-dark text-secondary">
        <div class="row g-5 py-5">
            <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-1 text-secondary text-center mb-0">Vinsmoke Sanji</h1>
            </div>
            <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                ...
                <p class="mb-0">
                    Di bawah kepemimpinan Sanji, 
                    koki jenius dengan prinsip untuk tidak membiarkan 
                    siapa pun kelaparan, Baratie mempertahankan reputasinya sebagai restoran legendaris dalam dunia One Piece. Setiap hidangan disajikan dengan dedikasi, menjadikan Baratie simbol cita rasa dan petualangan.
                </p>
            </div>
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                <p>
                   Restoran terapung Baratie adalah ikon kuliner East Blue
                yang menghadirkan hidangan kelas dunia di tengah samudra. Dengan desain kapal berbentuk ikan dan tim koki tangguh, Baratie menjadi tempat persinggahan
                    bagi siapa pun yang mencari pengalaman bersantap terbaik di lautan.
                </p>
                <p>
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-7">
                <div class="mb-4 wow fadeIn" data-wow-delay="0.2s">
                    ...
                    <h1 class="display-3 mb-0">Cooking Together With the Pirate Chef</h1>
                </div>
                <p class="mb-4 wow fadeIn" data-wow-delay="0.3s">Di tengah samudra luas tempat bajak laut berlayar dan legenda tercipta, Baratie berdiri sebagai rumah bagi cita rasa yang tak tertandingi. Restoran terapung ini menggabungkan semangat petualangan laut dengan seni memasak kelas dunia, 
                    memberi pengalaman makan yang tak hanya mengenyangkan, tetapi juga penuh cerita.</p>
                <div class="row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="team-item position-relative">
                    ...
                    <div class="position-absolute start-0 bottom-0 d-flex flex-column justify-content-center w-100 rounded-bottom text-center"
                        ...
                        <h5 class="text-light">Tony-Tony Chopper</h5>
